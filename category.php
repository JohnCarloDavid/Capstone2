    ...
    <?php while($row = $result->fetch_assoc()): ?>
        <tr>
            ...
            <td class="quantity-actions">
                <i class="PLUS fas fa-plus-circle" data-action="increase" data-id="<?php echo htmlspecialchars($row['product_id']); ?>"></i>
                <i class="MINUS fas fa-minus-circle" data-action="decrease" data-id="<?php echo htmlspecialchars($row['product_id']); ?>"></i>
            </td>
        </tr>
    <?php endwhile; ?>
</tbody>
